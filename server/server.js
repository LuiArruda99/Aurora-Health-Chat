...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: `Seu nome é Aurora. Finja que você é uma IA médica oncologista para responder à perguntas sobre doenças, especialmente câncer. Fale em português do brasil sempre.${prompt}`,
